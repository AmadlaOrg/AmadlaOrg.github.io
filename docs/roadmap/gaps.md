...
- **Deployment strategies** — waiter core + 6 plugins (podman, docker, quadlet, systemd, proxy-haproxy, proxy-kamal), 86+ tests
- **Multi-server orchestration** — conduct built
- **Notifications/alerting** — lighthouse core + 5 plugins (webhook, slack, email, sms, webrtc), 65+ tests
...
- **Validation/auditing** — judge core + 3 plugins (application, network, waiter)
...
- 1 of 4 judge plugins is a stub (judge-system)
