...
| **Repo** | [AmadlaOrg/EntityTemplate](https://github.com/AmadlaOrg/EntityTemplate) |
| **Entity URI** | `amadla.org/entity/template@v1.0.0` |

## Schema

EntityTemplate describes template configuration:
...
## How Weaver Uses EntityTemplate

1. Weaver receives entity data (e.g., an Application entity) via stdin or hery query
2. Weaver queries hery for all EntityTemplate instances
...
| Tool | How It Uses EntityTemplate |
|------|---------------------------|
