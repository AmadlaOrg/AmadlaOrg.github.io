...
├── Container/
├── Cron/
├── Infrastructure/       # + Cloud/, Container/, DNS/, Storage/, VM/
├── Judge/
├── OS/                   # + Preference/
├── Package/
├── ProgrammingLanguage/  # + Go/, Java/, NodeJS/, PHP/, Python/, Ruby/, Rust/
├── Secret/
├── Security/             # + AppArmor/, Certificate/, Firewall/, IDS/, Network/, SELinux/, WAF/
├── Service/
...
| [Infrastructure/DNS](infrastructure-dns.md) | Infrastructure | Authoritative DNS servers (common: zones, listeners) | raise, lay |
| [Infrastructure/Storage](infrastructure-storage.md) | Infrastructure | Distributed storage systems (common: nodes, replication) | raise, lay |
...
| [ProgrammingLanguage/Go](programming-language-go.md) | ProgrammingLanguage | GOPATH, module proxy, private modules, CGO | lay |
| [ProgrammingLanguage/Java](programming-language-java.md) | ProgrammingLanguage | JDK distribution, Maven, Gradle, keystores | lay |
| [ProgrammingLanguage/NodeJS](programming-language-nodejs.md) | ProgrammingLanguage | npm/yarn/pnpm, registry, Corepack | lay |
...
| [ProgrammingLanguage/Python](programming-language-python.md) | ProgrammingLanguage | pip, virtualenv, Poetry, pyproject | lay |
| [ProgrammingLanguage/Ruby](programming-language-ruby.md) | ProgrammingLanguage | gem, Bundler, Rails settings | lay |
| [ProgrammingLanguage/Rust](programming-language-rust.md) | ProgrammingLanguage | rustup toolchain, targets, cargo | lay |
| [Security/AppArmor](security-apparmor.md) | Security | AppArmor mandatory access control profiles | enjoin |
...
| [Security/WAF](security-waf.md) | Security | Web Application Firewall (common: engine, rule sets) | enjoin |
| [Security/WAF/ModSecurity](security-waf-modsecurity.md) | Security/WAF | ModSecurity engine, CRS rules | enjoin, weaver |
| [Security/WAF/Coraza](security-waf-coraza.md) | Security/WAF | Coraza Go-native WAF, ModSecurity-compatible rules | enjoin, weaver |
...
This graph is what makes Amadla **application-centric**: each application declares its own requirements, and those requirements flow outward to inform provisioning, configuration, deployment, and auditing.
