...
| **Parent type** | [EntityApplication](entity-application.md) |

## Schema

EntityApplication/DB describes database requirements:
...
| Tool | How It Uses EntityApplication/DB |
|------|----------------------------------|
...
| Sub-type | Purpose |
|----------|---------|
| [DB/RDBMS](entity-application-db-rdbms.md) | Relational-specific: migrations, replication, backup, connection pooling |
