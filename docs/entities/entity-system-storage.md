# EntitySystem/Storage

| Field | Value |
|-------|-------|
| **Purpose** | Defines storage and volume configuration — inspired by Docker Compose volumes |
| **Repo** | [AmadlaOrg/Entities/System/Storage](https://github.com/AmadlaOrg/Entities) |
| **Entity URI** | `amadla.org/entity/system/storage@v1.0.0` |
| **Parent type** | [EntitySystem](entity-system.md) |

## Schema

EntitySystem/Storage describes storage requirements:
...
```yaml
_type: amadla.org/entity/system/storage@v1.0.0
_body:
  volumes:
    - name: app-data
      driver: local
...
| Tool | How It Uses EntitySystem/Storage |
|------|-----------------------------------|
| lay | Creates volumes and mount points |
