# EntityInfrastructure/Container
...
EntityInfrastructure/Container describes container infrastructure requirements:
...
| Tool | How It Uses EntityInfrastructure/Container |
|------|---------------------------------------------|
